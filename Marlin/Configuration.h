...
#define AXEL_TPARA
  ...
  #define TPARA_LINKAGE_1 180       // (mm)
  #define TPARA_LINKAGE_2 180       // (mm)
...
#define DEFAULT_EJERK    0.3
  ...
  #define MANUAL_Y_HOME_POS (TPARA_LINKAGE_1)
  #define MANUAL_Z_HOME_POS TPARA_LINKAGE_2
#else
  #define MANUAL_X_HOME_POS 0
...
#define STRING_CONFIG_H_AUTHOR "Tintai" // Who made the changes.
